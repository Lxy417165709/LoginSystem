drop table tb_userAccountInformation CASCADE;
...
drop table tb_userpersonalInformation CASCADE;
create table tb_userPersonalInformation(
    userId integer serial primary key references tb_userAccountInformation(userId) on delete cascade,
