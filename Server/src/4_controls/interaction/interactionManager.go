...
// 获取请求中的Data
func (im *interactionManager)FormData(r *http.Request, dataPointer interface{}) error {
...
func (im *interactionManager)GetPhotoRspData(photoBase64 string) ([]byte, error) {
	var bytes []byte
	var err error
	if bytes, err = json.Marshal(commonStruct.GetPhotoRspData{PhotoBase64: photoBase64});err != nil {
		logs.Error(err)
		return nil,err
	}
	return bytes, nil
